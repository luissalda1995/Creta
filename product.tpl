		...
		*}
		...
		<div class="pb-left-column col-xs-12 col-sm-6 col-md-7">
			...
			<div id="image-block" class="clearfix">
				{if $product->new}
					<span class="new-box product-new-box">
...
{else}
	<div class="row {if $display_type eq 'left_tabs' || $display_type eq 'left_vertical_tabs'} tabgroup_left{/if}{if $display_type eq 'right_tabs' || $display_type eq 'right_vertical_tabs'} tabgroup_left{/if} indent">

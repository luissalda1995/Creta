			...
			<div class="product-container" itemscope itemtype="https://schema.org/Product">
				...
				<div class="right-block">
					...
					<div class="button-container">
						...
						{*<a href="#" id="wishlist_button_nopop" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', 0, 1); return false;" rel="nofollow"  title="{l s='Add to my wishlist' mod='blockwishlist'}" class="add_to_wishlist">
